        ...
        <div class="row row-height">
            <div class="col-lg-6 content-left d-none d-md-block">
                <div class="content-left-wrapper">
                    <a href="../../external.html?link=https://bukutamu.ciamiskab.go.id/" id="logo"
                    ...
                    <div>
                        ...
                        <a href="../../external.html?link=https://bukutamu.ciamiskab.go.id/" class="btn_1 rounded">Kembali
                            ke Home</a>
                    ...
                    <form class="" method="post"
                        ...
                        <div id="middle-wizard" style="margin-top: 300px;">
                            ...
                            <div class="step">
                                ...
                                <div class="form-group">
                                    <input type="text" id="input_nama" name="nama" class="form-control required"
                                ...
                                <div class="form-group">
                                    <input type="number" id="input_telp" name="telp"
                            ...
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    <div class="col-md-12 mb-3">
                                        <h3>Bagaimana pendapat Saudara tentang kesesuaian persyaratan pelayanan dengan jenis
                                            pelayanannya?</h3>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_radio version_2">

																					<img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Tidak Sesuai
                                            <input type="radio" id="opsi_3_15" name="respon[3]" value="15"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Kurang Sesuai
                                            <input type="radio" id="opsi_3_16" name="respon[3]" value="16"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Sesuai
                                            <input type="radio" id="opsi_3_17" name="respon[3]" value="17"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Sangat Sesuai
                                            <input type="radio" id="opsi_3_18" name="respon[3]" value="18"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        ...
                                        <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/3.jpg') }}"
                                            alt="" width="65%">
                                    </div>
                                </div>
                            </div>
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    <div class="col-md-12 mb-3">
                                        <h3>Bagaimana pemahaman Saudara tentang kemudahan prosedur pelayanan di unit ini?
                                        </h3>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Tidak Mudah
                                            <input type="radio" id="opsi_4_19" name="respon[4]" value="19"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Kurang Mudah
                                            <input type="radio" id="opsi_4_20" name="respon[4]" value="20"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Mudah
                                            <input type="radio" id="opsi_4_21" name="respon[4]" value="21"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Sangat Mudah
                                            <input type="radio" id="opsi_4_22" name="respon[4]" value="22"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
																			 <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/4.jpg') }}"
                                            alt="" width="65%">
                            ...
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    <div class="col-md-12 mb-3">
                                        <h3>Bagaimana pendapat Saudara tentang kecepatan waktu dalam memberikan pelayanan?
                                        </h3>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Tidak Cepat
                                            <input type="radio" id="opsi_5_23" name="respon[5]" value="23"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Kurang Cepat
                                            <input type="radio" id="opsi_5_24" name="respon[5]" value="24"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Cepat
                                            <input type="radio" id="opsi_5_25" name="respon[5]" value="25"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Sangat Cepat
                                            <input type="radio" id="opsi_5_26" name="respon[5]" value="26"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
																			 <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/5.jpg') }}"
                                            alt="" width="65%">
                            ...
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    <div class="col-md-12 mb-3">
                                        <h3>Bagimana pendapat Saudara tentang kesesuaian produk pelayanan antara yang
                                            tercantum dalam standard pelayanan dengan hasil yang diberikan?</h3>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Tidak Sesuai
                                            <input type="radio" id="opsi_6_27" name="respon[6]" value="27"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Kurang Sesuai
                                            <input type="radio" id="opsi_6_28" name="respon[6]" value="28"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Sesuai
                                            <input type="radio" id="opsi_6_29" name="respon[6]" value="29"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Sangat Sesuai
                                            <input type="radio" id="opsi_6_30" name="respon[6]" value="30"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
																			 <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/6.jpg') }}"
                                            alt="" width="65%">
                            ...
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    <div class="col-md-12 mb-3">
                                        <h3>Bagaimana Kesesuaian biaya dengan aturan tarif layanan? (Apabila pelayanan tidak
                                            dipungut biaya/gratis dipilih Sesuai)</h3>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Tidak Sesuai
                                            <input type="radio" id="opsi_7_31" name="respon[7]" value="31"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Kadang Sesuai
                                            <input type="radio" id="opsi_7_32" name="respon[7]" value="32"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Kurang Sesuai
                                            <input type="radio" id="opsi_7_33" name="respon[7]" value="33"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Sesuai
                                            <input type="radio" id="opsi_7_34" name="respon[7]" value="34"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
																			 <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/7.jpg') }}"
                                            alt="" width="65%">
                            ...
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    <div class="col-md-12 mb-3">
                                        <h3>Bagaimana pendapat Saudara tentang kompetensi / kemampuan petugas dalam
                                            pelayanan?</h3>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Tidak Kompeten
                                            <input type="radio" id="opsi_8_35" name="respon[8]" value="35"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Kurang Kompeten
                                            <input type="radio" id="opsi_8_36" name="respon[8]" value="36"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Kompeten
                                            <input type="radio" id="opsi_8_37" name="respon[8]" value="37"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Sangat Kompeten
                                            <input type="radio" id="opsi_8_38" name="respon[8]" value="38"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
																			 <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/8.jpg') }}"
                                            alt="" width="65%">
                            ...
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    <div class="col-md-12 mb-3">
                                        <h3>Bagaimana pendapat Saudara perilaku petugas dalam pelayanan terkait kesopanan
                                            dan keramahan?</h3>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Tidak Sopan dan Ramah
                                            <input type="radio" id="opsi_9_39" name="respon[9]" value="39"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Kurang Sopan dan Ramah
                                            <input type="radio" id="opsi_9_40" name="respon[9]" value="40"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Sopan dan Ramah
                                            <input type="radio" id="opsi_9_41" name="respon[9]" value="41"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Sangat Sopan dan Ramah
                                            <input type="radio" id="opsi_9_42" name="respon[9]" value="42"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
																			 <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/9.jpg') }}"
                                            alt="" width="65%">
                            ...
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    ...
                                    <div class="col-md-6">
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Buruk
                                            <input type="radio" id="opsi_10_43" name="respon[10]" value="43"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Cukup
                                            <input type="radio" id="opsi_10_44" name="respon[10]" value="44"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Baik
                                            <input type="radio" id="opsi_10_45" name="respon[10]" value="45"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Sangat Baik
                                            <input type="radio" id="opsi_10_46" name="respon[10]" value="46"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
																			 <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/10.jpg') }}"
                                            alt="" width="65%">
                            ...
                            <div class="step">
                                <div class="row" style="align-items: end !important;">
                                    <div class="col-md-12 mb-3">
                                        <h3>Bagaimana pendapat Saudara tentang penanganan pengaduan dan penggunaan layanan?
                                        </h3>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/d.png")}}" alt=""
                                                width="10%"> Tidak Ada
                                            <input type="radio" id="opsi_11_47" name="respon[11]" value="47"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/c.png")}}" alt=""
                                                width="10%"> Ada tetapi tidak berfungsi
                                            <input type="radio" id="opsi_11_48" name="respon[11]" value="48"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/b.png")}}" alt=""
                                                width="10%"> Berfungsi kurang maksimal
                                            <input type="radio" id="opsi_11_49" name="respon[11]" value="49"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio version_2"><img src="{{asset("assets/templateskm/survey/smiley/a.png")}}" alt=""
                                                width="10%"> Dikelolah dengan baik
                                            <input type="radio" id="opsi_11_50" name="respon[11]" value="50"
                                                class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 text-right">
																			 <img src="{{ asset('assets/templateskm/survey/img_pertanyaan/11.jpg') }}"
                                            alt="" width="65%">
