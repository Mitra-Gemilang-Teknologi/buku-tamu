                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <ul class="nav nav-pills ml-auto">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#Harian"
                                            data-toggle="tab"style="color: black !important">Harian</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#Mingguan"
                                            data-toggle="tab"style="color: black !important">Mingguan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#Bulanan"
                                            data-toggle="tab"style="color: black !important">Bulanan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#Layanan"
                                            data-toggle="tab"style="color: black !important">Layanan</a>
                                    </li>
                                </ul>
                            </div>
                        </div><!-- /.card-header -->
